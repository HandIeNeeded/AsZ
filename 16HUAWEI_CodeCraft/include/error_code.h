...
#define ASZ_SOLUTION_CHECKER_NO_EDGE_ERROR -2001
#define ASZ_SOLUTION_CHECKER_NO_EDGE_WARNING 2001
#define ASZ_SOLUTION_CHECKER_INVALID_START_POINT_ERROR -2002
#define ASZ_SOLUTION_CHECKER_INVALID_START_POINT_WARNING 2002
#define ASZ_SOLUTION_CHECKER_INVALID_END_POINT_ERROR -2003
#define ASZ_SOLUTION_CHECKER_INVALID_END_POINT_WARNING 2003
#define ASZ_SOLUTION_CHECKER_PATH_NOT_CONNECTED_ERROR -2004
#define ASZ_SOLUTION_CHECKER_PATH_NOT_CONNECTED_WARNING 2004
#define ASZ_SOLUTION_CHECKER_REPEAT_NODES_ERROR -2005
#define ASZ_SOLUTION_CHECKER_REPEAT_NODES_WARNING 2005
#define ASZ_SOLUTION_CHECKER_NOT_COVER_ALL_KEY_POINTS_ERROR -2006
#define ASZ_SOLUTION_CHECKER_NOT_COVER_ALL_KEY_POINTS_WARNING 2006
...
static inline std::string PRINTREADABLEINFO(int x) {
    ...
    case ASZ_SOLUTION_CHECKER_PATH_NOT_CONNECTED_ERROR:
        return STRINGIFY(ASZ_SOLUTION_CHECKER_PATH_NOT_CONNECTED_ERROR);
    ...
    case ASZ_SOLUTION_CHECKER_PATH_NOT_CONNECTED_WARNING:
        return STRINGIFY(ASZ_SOLUTION_CHECKER_PATH_NOT_CONNECTED_WARNING);
